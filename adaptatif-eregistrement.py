...
output_folder = "result-adaptatif"
...
class Image:
    ...
    def write_and_save_image(self, iteration):
        output_path = os.path.join(output_folder, f"iteration_{iteration}.png")
        cv2.imwrite(output_path, self.source)
    ...
    while contain_invalid_germ and i <= 1000:
        ...
        for germ in img.germs:
            ...
            if var > 1000:
                ...
                bellow += 1
            img.write_and_save_image(i +100)
        print(f"{over} values overs 1000 and {bellow} values bellow 1000")
        img.write_and_save_image(i)
        img.write_and_display_image()
        i += 1
